...
import (
	...
	. "arctron.cn/arctron/arcplus/qiniu/internal"
)

const (
	name    = "qiniu" // service name
	defPort = 15005   // default listening port
)

var (
	serv = flag.String("qiniu", "qiniu", "service name")
...
func main() {
	...
	s := grpc.NewServer()
	pb.RegisterQiniuServer(s, &QiniuServer{})
