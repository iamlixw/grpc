...
import (
	...
	. "arctron.cn/arctron/arcplus/member/internal"
	pb "arctron.cn/arctron/arcplus/pb/member"
)

const (
	name    = "member" // service name
	defPort = 14005    // default listening port
)

var (
	serv = flag.String("member", "member", "service name")
...
func main() {
	...
	s := grpc.NewServer()
	pb.RegisterMemberServer(s, &MemberServer{})
